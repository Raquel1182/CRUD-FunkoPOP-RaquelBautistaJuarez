<%-- 
    ...
    Created on : 4 jul 2020, 21:29:18
    Author     : Raquel
--%>
...
<%
    ...
    try {
        ...
        stmt = conexion.prepareStatement("INSERT INTO cat_categorias SET nombre=?");
        stmt.setString(1, request.getParameter("nombre"));
        if (stmt.executeUpdate() == 1) {
%>
<div class="alert alert-success" role="alert">
    <h2>Se agregó la nueva categoria exitosamente en la base de datos</h2>
</div>
<% 
    }
%>
